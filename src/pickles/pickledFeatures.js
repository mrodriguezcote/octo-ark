jsonPWrapper ({
  "Features": [
    ...
    {
      "RelativeFolder": "checkout.feature",
      "Feature": {
        "Name": "Checkout",
        "Description": "  As a user of the YETI site\n  I want to have access to the product page\n  So that I purchase a simple product",
        "FeatureElements": [
          {
            "Name": "Checking out with simple product",
            "Slug": "checking-out-with-simple-product",
            "Description": "",
            "Steps": [
              {
                "Keyword": "Given",
              ...
              },
              {
                "Keyword": "When",
                "NativeKeyword": "When ",
                "Name": "I proceed through checkout",
                "StepComments": [],
                "AfterLastStepComments": []
              },
              {
                "Keyword": "And",
                "NativeKeyword": "And ",
                "Name": "I have submitted my order",
                "StepComments": [],
                "AfterLastStepComments": []
              },
              {
              ...
              },
              {
                "Keyword": "Then",
                "NativeKeyword": "Then ",
                "Name": "My order is created in Magento",
                "StepComments": [],
                "AfterLastStepComments": []
              }
            ],
